...
<div class="hero">
    <div class="hero-wrapper">
        <div class="hero-wrapper__content">
            <h1 class="header-xl"><?php echo $text; ?></h1>
            <p class="text-m"><?php echo $description; ?></p>
            <div class="hero__buttons">
                <a href="<?php echo $button_url_primary; ?><" class="button-primary"><?php echo $button_text_primary; ?>
                </a>
        ...
        <div class="hero-wrapper__image">
            ...
            <div class="hero__image" style="background-image: url(<?php echo $image; ?>);"></div>
        </div>
