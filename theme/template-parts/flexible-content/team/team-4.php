...
$section_description = get_sub_field('section_description') ?: 'Description - short description of the text';
...
if (!function_exists('get_team_section_img_url')) {
    function get_team_section_img_url($img) {
...
<section class="team py-5">
    <div class="container">
        ...
        <div class="d-flex flex-wrap justify-content-center align-items-stretch gap-3">
            ...
            <div class="team-card text-center p-3" style="flex: 1 1 300px; max-width: 350px;">
                <?php 
                $img_url_1 = get_team_section_img_url($member_1_image);
                if (!empty($img_url_1)): 
                ?>
                <div class="mb-3">
            ...
            <div class="team-card text-center p-3" style="flex: 1 1 300px; max-width: 350px;">
                <?php 
                $img_url_2 = get_team_section_img_url($member_2_image);
                if (!empty($img_url_2)): 
                ?>
                <div class="mb-3">
            ...
            <div class="team-card text-center p-3" style="flex: 1 1 300px; max-width: 350px;">
                <?php 
                $img_url_3 = get_team_section_img_url($member_3_image);
                if (!empty($img_url_3)): 
                ?>
                <div class="mb-3">
